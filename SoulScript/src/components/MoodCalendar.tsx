        ...
        {entries.length > 0 && (
          <div className="space-y-2 text-center">
            <button
              ...
              className="inline-flex items-center gap-2 px-8 py-4 bg-gradient-to-b from-accent to-accent-glow text-white font-semibold rounded-full shadow-[0_4px_16px_rgba(124,92,252,0.3)] hover:scale-105 hover:shadow-[0_6px_24px_rgba(124,92,252,0.45)] transition-all duration-300"
            >
