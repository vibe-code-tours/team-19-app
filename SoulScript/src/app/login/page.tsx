      ...
      <div className="w-full max-w-sm space-y-8 relative z-10">
        ...
        <form onSubmit={handleEmailLogin} className="space-y-4">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-3.5 bg-gradient-to-b from-accent to-accent-glow text-white font-semibold rounded-xl shadow-[0_4px_24px_rgba(88,44,255,0.45),0_1px_3px_rgba(124,92,252,0.5)_inset] hover:shadow-[0_6px_32px_rgba(88,44,255,0.55)] transition-all disabled:opacity-50"
          >
